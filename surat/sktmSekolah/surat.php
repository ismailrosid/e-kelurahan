...
if (isset($_POST['submit'])) { ?>
  <?php
  $tersimpan = saveSktmSekolah($_POST);
  if (
    $tersimpan[0] != "0" ||
    $tersimpan[0] != "00"
  ) {
    if ($tersimpan[0] == "1") { ?>
      <script>
        ...
        var z = "<?php echo $tersimpan[2] == '1.1' ?>" ? 'sktmSekolah' : 'pengiriman';
        if (z != "pengiriman") {
          saveDone(x, z);
          // saveDoneA(x, z);
        } else {
          saveDoneA(x, z, 'sktmSekolah');
        }
      </script>
...
<div id="modal-sktmSekolahCreate" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg ">
    <form action="" method="post">
        ...
        <div class="modal-body">
          <div class="container">
            <div class="row">
              ...
              <!-- content -->
              <?php include "surat/sktmSekolah/template.php"; ?>
              <!-- end -->
            </div>
          </div>
        </div>
      ...
      <form id="form-formSktmSekolah" action="">
        <!-- input hidden untuk id Pejabat -->
