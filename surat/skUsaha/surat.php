...
if (isset($_POST['submit'])) { ?>
  ...
  if (
    ...
    if ($tersimpan[0] == "1") { ?>
      <script>
        ...
        var z = "<?php echo $tersimpan[2] == '1.1' ?>" ? 'skUsaha' : 'pengiriman';
        if (z != "pengiriman") {
          saveDone(x, z);
          // saveDoneA(x, z);
        } else {
          saveDoneA(x, z, 'skUsaha');
        }
      </script>
  ...
  <?php } ?>
<?php } ?>
<div id="modal-skUsahaCreate" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
          <div class="container">
            <div class="row">
              ...
              <!-- ISI -->
              <?php include "surat/skUsaha/template.php"; ?>
              <!-- END -->
            </div>
          </div>
        </div>
